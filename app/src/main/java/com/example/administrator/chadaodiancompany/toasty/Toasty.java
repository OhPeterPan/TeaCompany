package com.example.administrator.chadaodiancompany.toasty;
...
public class Toasty {
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        if (mToast == null) {
            mToast = new Toast(UIUtil.getContext());
        }

  /*      final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.toast_layout, null);*/
        View toastLayout = LayoutInflater.from(UIUtil.getContext()).inflate(R.layout.toast_layout, null);
        final ImageView toastIcon = toastLayout.findViewById(R.id.toast_icon);
        final TextView toastTextView = toastLayout.findViewById(R.id.toast_text);
        Drawable drawableFrame;

        if (shouldTint)
            drawableFrame = ToastyUtils.tint9PatchDrawableFrame(UIUtil.getContext(), tintColor);
        else
            drawableFrame = ToastyUtils.getDrawable(UIUtil.getContext(), R.drawable.toast_frame);
