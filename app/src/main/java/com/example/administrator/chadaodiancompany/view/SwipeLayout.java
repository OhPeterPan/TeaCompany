...
public class SwipeLayout extends FrameLayout {
    ...
    public void isState(boolean isOpen) {
        this.mOpen = isOpen;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // LogUtil.logI("啥情况？" + left + ":::" + top + "老的？" + right + ":::" + bottom);
        layoutInit(false);
    }
    ...
    protected void onFinishInflate() {
        ...
        //前置条目
        mFrontLayout = findViewById(R.id.layout_front);
    }
...
//            System.out.println(" releasedChild = " + releasedChild + "::xvel = " + xvel);
    ...
    private SwipeState updateState() {
        if (mFrontLayout.getLeft() == -mRange) { // 打开
            mSwipeState = SwipeState.OPEN;
            return SwipeState.OPEN;
        } else if (mFrontLayout.getLeft() == 0) {
            mSwipeState = SwipeState.CLOSE;
